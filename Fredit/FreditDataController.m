...
#import "FreditDataController.h"

@interface FreditDataController()
@property (strong, nonatomic, readwrite) NSPersistentContainer *persistentContainer;
@end

@implementation FreditDataController
...
- (id)initWithCompletionBlock:(VoidCallback)callback;
{
    self = [super init];
    if (!self) return nil;
